...
class App extends Component<Props, AppState> {
  ...
  setSelectionXY = () => {
    ...
    // TODO: This was previously document.body.parentNode which didn't have this method
...
class ToolbarButton extends Component<ToolbarProps, {}> {
  onMouseDown: MouseEventHandler<HTMLSpanElement> = (e) => {
    e.preventDefault()
  ...
  render() {
    ...
    return (
      <span onMouseDown={this.onMouseDown} style={buttonStyle}>
        {this.props.label}
      </span>
    )
  }
...
const ToolBar = (props: {editorState: EditorState, onToggle: (arg0: string)=>void}) => {
